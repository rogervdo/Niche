/** Map user-facing genre terms to Spotify genre tags / search terms. */
...
/** Primary search terms (Spotify `genre:"..."` queries). */
...
/** Search terms from inferred / anchor genres (no alias table hit). */
